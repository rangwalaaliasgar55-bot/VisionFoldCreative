    ...
    <div>
        ...
        >
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-6 py-2.5 glass rounded-xl text-sm text-white/60"
            >
              Cancel
            </button>
          </div>
      ...
      <div className="glass rounded-2xl p-4 border border-white/5 mb-6 flex items-center gap-3">
        ...
        <input
          ...
          className="bg-transparent text-white text-sm flex-1 focus:outline-none placeholder-white/30"
          value={search}
      ...
      <div className="space-y-3">
        {loading ? (
          ...
          <div className="glass rounded-2xl p-12 text-center text-white/40">No clients found.</div>
        ) : (
          filtered.map((client: any) => (
            ...
            >
              ...
              <button
                ...
                className="p-2 text-white/40 hover:text-coral transition-colors"
              >
