    ...
    <div>
      ...
      <div className="max-w-2xl space-y-6">
        ...
        <button
          onClick={save}
          disabled={saving}
          className="px-6 py-3 bg-accent text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-accent/30 transition-all disabled:opacity-50 flex items-center gap-2"
        >
