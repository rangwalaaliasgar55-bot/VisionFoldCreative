...
/**
 * FAQ ΓÇö the questions that otherwise arrive by email, one at a time.
 *
...
export const DEFAULT_FAQ: FaqItem[] = [
  {
    ...
    a: "It depends on footage volume, runtime and how much motion work is involved ΓÇö so we quote per project rather than posting a price that would be wrong for you. Use the quote builder, and you'll have a real number back within 24 hours. No hidden fees, and the rate is agreed before we start.",
  },
  {
  ...
  },
  {
    ...
    a: "Work is approved in passes ΓÇö story, assembly, polish, sound ΓÇö so notes are gathered at each stage instead of arriving all at once at the end. That usually means fewer rounds overall. The agreed number is written into your quote.",
  },
  {
  ...
  },
  {
    ...
    a: "Every format your brief asks for ΓÇö 16:9, 9:16, 1:1, 4:5 ΓÇö plus captions burned in or as a separate SRT. Deciding this up front is cheaper than reframing later, which is why the intake asks.",
  },
  {
    q: "Who owns the finished films?",
    a: "You do, in full, once the invoice is settled. We'll usually ask whether we can show the work in our portfolio ΓÇö if the answer is no, that's fine and it stays private.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes ΓÇö we work across twelve countries and the process is built to be asynchronous. Your review links, comments and files all live in the portal, so time zones stop mattering.",
  },
  {
...
export function Faq({
  ...
  intro = "If yours isn't here, send it over ΓÇö we answer briefs within 24 hours.",
}: {
  items?: FaqItem[];
  title?: string;
  intro?: string;
