  ...
  useEffect(() => {
    ...
    const nebulaMat = new THREE.ShaderMaterial({
      ...
      fragmentShader: `
        ...
        // A soft elliptical source ΓÇö this is a lamp, not a cloud.
        ...
        void main() {
          ...
          // Two lamps. That's the whole rig ΓÇö a third hue only muddies it.
    ...
    /* ------------------------------------------------------------------ */
    /* 2. Bokeh dust ΓÇö three depth shells                                  */
    /* ------------------------------------------------------------------ */
    const sprite = (() => {
    ...
    // Weighted warm-neutral palette ΓÇö dust, not confetti.
    const PALETTE = [
    ...
    /* ------------------------------------------------------------------ */
    /* 3. The Fold ΓÇö sheets of light creased by a shader                   */
    /* ------------------------------------------------------------------ */
      ...
      new THREE.ShaderMaterial({
        ...
        fragmentShader: `
          ...
          void main() {
            ...
            // fold compresses them they bloom into a wash instead of moir├⌐.
            ...
            // dissolve at every border ΓÇö no hard silhouette, ever
    ...
    // Primary fold ΓÇö violet key side, sweeping in from the left
    addFold({
      size: [26, 15],
      pos: [-15, -1, -14],
      rot: [-0.14, 0.85, 0.18],
    ...
    // Counter fold ΓÇö amber bounce side, further back and quieter
    addFold({
      size: [19, 10],
      pos: [16.5, 4, -19],
      rot: [0.16, -0.9, -0.22],
    ...
    // The enveloping "studio wall" ΓÇö camera sits inside it, so it reads as a
    ...
    const loop = () => {
      ...
      for (const f of folds) {
        ...
        // Scroll unfolds the sheet ΓÇö the story literally opens as you read.
