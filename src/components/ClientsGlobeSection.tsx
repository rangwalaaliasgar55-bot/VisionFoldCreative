...
export function ClientsGlobeSection() {
  ...
  useEffect(() => {
    ...
    // 1. Atmosphere — fresnel rim glow instead of a flat translucent shell
    ...
    // 2. Earth — standard material so the studio lights actually shape it
    ...
    // HQ Indore gold pin — ring is billboarded to the camera each frame
