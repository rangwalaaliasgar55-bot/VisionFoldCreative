...
export const ServicesPage: React.FC<ServicesPageProps> = ({ onNavigate }) => {
  ...
  const disclaimer =
    ...
    'This is a baseline rate. Final quotation depends on: complexity of the edit, raw footage length, motion graphics requirements, and number of revisions.';
  ...
  return (
    <div className="min-h-screen text-slate-100 pb-20 bg-[#08090d] font-sans">
      ...
      <section className="pt-16 pb-12 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto text-center">
        ...
        <p className="text-base sm:text-lg text-slate-300 mt-4 max-w-2xl mx-auto font-light leading-relaxed">
          Clear rate of <strong className="text-amber-400 font-bold">₹700 per finished minute</strong>. Premium retention editing by VisionFold Studio.
        </p>
      </section>

      {/* Pricing Cards Grid */}
      <section className="py-8 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto grid md:grid-cols-2 gap-6">
        {/* Short Form Card */}
        <div className="bg-[#0b0d13] border border-[#1a1d28] rounded-2xl p-8 hover:border-amber-400/40 transition-all flex flex-col justify-between shadow-xl">
          <div>
            <div className="w-10 h-10 rounded-xl bg-amber-400/10 text-amber-400 flex items-center justify-center mb-6 border border-amber-400/20">
              <Video className="w-5 h-5" />
            </div>
            <h2 className="text-xl font-bold text-white mb-1">Short Form Editing</h2>
            <p className="text-slate-400 text-xs font-mono mb-6">
              Instagram Reels, YouTube Shorts, TikToks & Social Ads
            </p>

            <div className="mb-6 p-4 rounded-xl bg-[#10121a] border border-[#181b26]">
          ...
          <button
            ...
            className="w-full py-3.5 rounded-xl bg-amber-400 hover:bg-amber-300 text-slate-950 font-mono font-bold uppercase text-xs tracking-widest transition-all shadow-md flex items-center justify-center gap-2"
          >
        ...
        <div className="bg-[#0b0d13] border border-[#1a1d28] rounded-2xl p-8 hover:border-amber-400/40 transition-all flex flex-col justify-between shadow-xl">
          <div>
            ...
            <h2 className="text-xl font-bold text-white mb-1">Long Form Editing</h2>
            <p className="text-slate-400 text-xs font-mono mb-6">
      ...
      <section className="py-4 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="p-4 rounded-xl bg-[#0b0d13] border border-[#1a1d28] text-slate-300 text-xs font-mono flex items-start gap-3 shadow-md">
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto">
        <div className="bg-[#0b0d13] border border-[#1a1d28] rounded-2xl p-8 shadow-xl">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-black text-white uppercase tracking-tight">Instant Rate Estimator</h2>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className={`py-2 px-3 rounded-lg text-xs font-mono font-bold uppercase border transition-all ${
                    calcType === 'short'
                      ? 'bg-amber-400 text-slate-950 border-amber-400'
                      : 'bg-[#10121a] text-slate-300 border-[#181b26]'
                  }`}
                >
                  Short Form
                </button>
            ...
            <div>
              ...
              <input
                ...
                className="w-full accent-amber-400 cursor-pointer h-2 bg-[#181b26] rounded-lg"
              />
          ...
          <div className="p-5 rounded-xl bg-[#10121a] border border-[#181b26] flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              <span className="text-[10px] uppercase font-mono font-bold text-slate-400 tracking-widest block">
                Estimated Quote
              </span>
            ...
            <button
              onClick={() => onNavigate('contact')}
              className="px-5 py-2.5 rounded-xl bg-amber-400 text-slate-950 font-mono font-bold uppercase text-xs tracking-widest hover:bg-amber-300 transition-all shrink-0"
            >
              Get Custom Quote
            </button>
          </div>
